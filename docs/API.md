...
- ถ้า `require_roll=true` แล้ว Roll ว่างหรือสั้นกว่าเกณฑ์ (เช่น อ่านได้ `33`) API จะยังตรวจคะแนนต่อและตอบ **HTTP 200** พร้อม `warnings[].code = "invalid_roll"` เพื่อให้ Laravel บันทึกเป็นรายการรอแก้รหัสนักเรียน
