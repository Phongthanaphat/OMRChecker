    ...
    "properties": {
        ...
        "threshold_params": {
            ...
            "properties": {
                ...
                "STRICT_EMPTY_THRESHOLD": {"type": "integer", "minimum": 80, "maximum": 200},
            },
        },
        "alignment_params": {
            "type": "object",
        ...
        "evaluation_overlay": {
            ...
            "properties": {
                "circle_radius_ratio": {
                    ...
                    "minimum": 0.1,
                    "maximum": 2.0,
                    "description": "Radius of correct/incorrect circle as ratio of bubble half-size (0.85 = 85%, 1.2 = 120% = larger than bubble)",
                },
                "circle_thickness": {
                    "type": "integer",
                    "minimum": 1,
                    "maximum": 15,
                    "description": "Line thickness of the circle in pixels",
                },
            },
        },
    },
