                            ...
                            "properties": {
                                "options": {
                                    ...
                                    "properties": {
                                        ...
                                        "enable_shadow_fallback": {"type": "boolean"},
                                        "max_axis_marker_inset_fraction": {"type": "number"},
                                        "max_axis_side_ratio": {"type": "number"},
                                        "max_axis_tilt_degrees": {"type": "number"},
                                        "shadow_dark_median_threshold": {"type": "number"},
                                        "shadow_quadrant_mean_threshold": {"type": "number"},
                                        "shadow_quadrant_spread_threshold": {"type": "number"},
                                        "shadow_retry_median_threshold": {"type": "number"},
                                        "shadow_retry_quadrant_mean_threshold": {"type": "number"},
                                        "shadow_retry_quadrant_spread_threshold": {"type": "number"},
